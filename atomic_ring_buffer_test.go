...
func TestAtomicRingBuffer_interface(t *testing.T) {
	rb := NewAtomicRingBuffer(1)
	var _ io.Writer = rb
	var _ io.Reader = rb
...
func TestAtomicRingBuffer_Write(t *testing.T) {
	rb := NewAtomicRingBuffer(64)
...
func TestAtomicRingBuffer_Read(t *testing.T) {
	rb := NewAtomicRingBuffer(64)
...
func TestAtomicRingBuffer_ByteInterface(t *testing.T) {
	rb := NewAtomicRingBuffer(2)
